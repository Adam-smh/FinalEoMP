# all imports
# cloudinary used to store images in db
import cloudinary
import cloudinary.uploader

# importing flask and jwt and CORS
...
class Product(object):
    def __init__(self, user_id, product_name, product_image, product_category, product_description, product_price):
...
def view_product(product_id): yt
    response = {}
